...
void Material::Bind(ComPtr<ID3D11DeviceContext>& context)
{
...
void Material::SetFactors(Color baseColor, float roughness, float metallic)
{
...
Material::MaterialStatus& Material::GetMaterialStatus()
{
